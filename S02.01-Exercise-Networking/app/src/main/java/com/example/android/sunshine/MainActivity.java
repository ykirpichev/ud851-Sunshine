...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        new DataLoader().execute(NetworkUtils.buildUrl(preferredWeatherLocation));
    }

    class DataLoader extends AsyncTask<URL, Void, String[]> {

        @Override
        protected String[] doInBackground(URL... urls) {
            try {
                String response = getResponseFromHttpUrl(urls[0]);
