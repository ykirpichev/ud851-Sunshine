...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,
    ...
    private static final String QUERY_REQUEST_EXTRA = "query_request_extra";
    ...
    private void loadWeatherData() {
        ...
        bundle.putString(QUERY_REQUEST_EXTRA, location);

        getSupportLoaderManager().restartLoader(DATA_LOADER, bundle, this);
    }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                String requestUrl = args.getString(QUERY_REQUEST_EXTRA);
                ...
                try {
                    URL weatherRequestUrl = NetworkUtils.buildUrl(requestUrl);
